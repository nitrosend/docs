...
<CardGroup cols={1}>
  <Card title="nitrosend.com/SKILL.md" icon="bolt" href="https://nitrosend.com/SKILL.md">
...
<CardGroup cols={2}>
  <Card title="MCP (recommended)" icon="server-stack">
  ...
  <Card title="Headless REST" icon="command-line">
...
One command (or, in Claude Desktop and Claude.ai, the official Nitrosend connector under **Settings → Connectors**) plus OAuth sign-in:
...
<Steps>
  ...
  <Step title="Activate the reserved sender">
