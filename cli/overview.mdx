...
<Info>
  If you're using Claude Desktop, Claude.ai, or Claude Cowork, do not install the CLI to connect Nitrosend. Add the remote MCP connector at `https://api.nitrosend.com/mcp` instead. The CLI is for shell workflows that run outside the Claude Desktop connector.
</Info>
...
| **CLI** (`nitrosend`) | You're scripting CI, building an agent runner, or running Nitrosend from a terminal. You need exit codes, JSON envelopes, dry-run, typed prod confirmation. | You're connecting Claude Desktop, Claude.ai, or Cowork; use remote MCP instead. You're integrating Nitrosend into application code. |
