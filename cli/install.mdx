...
<Info>
  This page is for terminal, CI, and headless agent-runner workflows. Claude Desktop, Claude.ai, and Claude Cowork users should not install the CLI to connect Nitrosend; add the remote MCP connector at `https://api.nitrosend.com/mcp` instead.
</Info>
...
Get an API key from **Settings > API Keys** in the [Nitrosend dashboard](https://app.nitrosend.com/my/settings/api-keys), then either store it as a profile:
