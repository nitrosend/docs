...
Read-only list commands call `nitro_query` and return paginated rows.

| Command | Summary |
|---|---|
| `nitrosend flows list` | List flows. |
| `nitrosend campaigns list` | List campaigns. |
| `nitrosend contacts list` | List contacts. |
| `nitrosend lists list` | List contact lists. |
| `nitrosend templates list` | List templates. |
| `nitrosend suppressions list` | List account suppressions with bounce diagnostics. |
