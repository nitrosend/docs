...
That's it — no API key needed. Or point Claude Code at the install skill, [nitrosend.com/SKILL.md](https://nitrosend.com/SKILL.md), and it runs the setup itself.
