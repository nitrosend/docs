...
**MCP (Model Context Protocol)** is an open standard that lets AI tools connect to external services. When you add Nitrosend as an MCP server to Claude Code, Claude gets native access to 19 email marketing tools — no API wrappers, no middleware, no boilerplate.
...
<Card title="Full examples with tool calls" icon="book-open" href="/guides/mcp-examples">
  Complete prompt, tool call JSON, and response walkthroughs.
</Card>
