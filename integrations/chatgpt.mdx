...
Connect Nitrosend to ChatGPT via Developer mode MCP for full access to all 23 tools, or use a custom GPT with API actions if you want a tailored wrapper.

## Option 1: MCP Server (Recommended)

ChatGPT Developer mode provides MCP client support for remote servers. This gives you direct access to all 23 Nitrosend tools without any local setup.
