---
title: ChatGPT / GPT
description: Connect Nitrosend to ChatGPT as a Browser App through MCP
---

# ChatGPT / GPT

Connect Nitrosend to ChatGPT as a Browser App. ChatGPT handles the MCP connection and Nitrosend authenticates your account — no API key or local setup required.

## Option 1: Browser App (Recommended)

ChatGPT Browser Apps provide MCP client support for connected apps. This gives you direct access to Nitrosend tools without copying API keys.

### 1. Open Browser Apps

In ChatGPT, click your name, then open **Settings** → **Apps** → **Browser Apps**.
...
<Info>
  No API key or local dependencies required. Authentication is handled through your Nitrosend account when you connect the Browser App.
</Info>
