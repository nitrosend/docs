...
For programmatic integration or Google AI Studio, you can define Nitrosend operations as function declarations and call the REST API directly. This requires an API key from **Brand > API Keys** in the [Nitrosend dashboard](https://app.nitrosend.com/my/brand/api-keys).
...
NITROSEND_API_KEY = "nskey_live_your_key_here"  # From Brand > API Keys
