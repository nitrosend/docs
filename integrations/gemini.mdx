...
Gemini CLI has native MCP support, giving you the full Nitrosend toolkit — 23 tools, live Brand Kit context, and account state — directly in your terminal.
...
Gemini now has access to all 23 Nitrosend MCP tools — composing emails, managing contacts, building flows, checking analytics, and more.
