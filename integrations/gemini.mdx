...
Gemini CLI has native MCP support, giving you the full Nitrosend toolkit — 19 tools, live brand context, and account state — directly in your terminal.
...
Gemini now has access to all 19 Nitrosend MCP tools — composing emails, managing contacts, building flows, checking analytics, and more.
