...
- **Set up your Brand Settings first.** Go to [Brand Settings](https://app.nitrosend.com/my/brand) and configure your brand colors, fonts, and logo. Claude uses this automatically when composing emails.
