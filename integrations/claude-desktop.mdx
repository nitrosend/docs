...
Once connected via MCP, Claude has access to **23 specialized tools** and **live resources** about your account. Here's what that means in practice:
...
- **Set up your Brand Kit first.** Go to [Brand Kit](https://app.nitrosend.com/my/client-account) and configure your brand colors, fonts, and logo. Claude uses this automatically when composing emails.
- **Use AI Memory.** Go to [AI Memory](https://app.nitrosend.com/my/client-account/memory) to tell Nitrosend about your business goals, target audience, and email strategy. Claude reads this to make smarter decisions.
