...
Once connected via MCP, Claude has access to **19 specialized tools** and **live resources** about your account. Here's what that means in practice:
...
<Card title="More examples" icon="book-open" href="/guides/mcp-examples">
  Complete AI workflow examples with tool call details.
</Card>

## Alternative: Manual config file (older versions)

If the Custom Connector method isn't available in your version of Claude Desktop, you can configure MCP manually using the stdio bridge and an API key:
