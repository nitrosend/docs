...
secret delivery, plan changes, and billing. Nitrosend handles account, client account,
...
`nitrosend-email` resource. The resource maps to a Nitrosend account and client account,
...
- manage client accounts and sending domains
...
Nitrosend dashboard with the right account and client-account context.
