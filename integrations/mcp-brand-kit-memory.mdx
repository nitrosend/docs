...
<Tabs>
  <Tab title="Dashboard">
    Go to [**Brand > Brand Kit**](https://app.nitrosend.com/my/brand) in the Nitrosend dashboard. Fill in your Brand Kit details and click save.
  </Tab>
...
<Tabs>
  <Tab title="Dashboard">
    Go to [**Settings > AI Memory**](https://app.nitrosend.com/my/settings/memory) in the Nitrosend dashboard. Edit the markdown document and save.
  </Tab>
  <Tab title="Via MCP (AI prompt)">
    Ask your connected AI assistant:
    ```
