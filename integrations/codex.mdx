...
description: Give Codex CLI access to Nitrosend for AI-powered email automation from your terminal
---

# OpenAI Codex CLI

[Codex CLI](https://github.com/openai/codex) is OpenAI's terminal-based coding agent. You can give Codex access to Nitrosend by providing it with the REST API and a wrapper script, letting it manage your email marketing from the command line.
