...
[Codex CLI](https://github.com/openai/codex) is OpenAI's terminal-based coding agent. Connect Nitrosend via MCP for full access to all 21 tools, or use the REST API with a helper script.
