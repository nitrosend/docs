...
<Warning>
  The MCP call stores the tokens without testing them. Verify with `{"operation": "status"}` or run **Test connection** from the Postmark integration page in the dashboard.
</Warning>
