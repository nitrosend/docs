...
### Brand Kit + email in one prompt

```
Scrape my Brand Kit from https://mysite.com and compose a launch announcement email.
```
...
<AccordionGroup>
  ...
  <Accordion title="Tool calls time out">
    Brand Kit scraping takes 20-30 seconds (one-time). Other calls should complete in 1-3 seconds. Check your network if timeouts persist.
  </Accordion>
</AccordionGroup>
