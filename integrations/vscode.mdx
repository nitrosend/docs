...
Click the **Configure Tools** button in the Copilot chat input to see every available Nitrosend tool. You can toggle specific tools on or off.
...
```
Set up my Brand Kit from https://mysite.com and draft a welcome email for new subscribers.
```
...
<AccordionGroup>
  ...
  <Accordion title="Tool calls time out">
    Brand Kit scraping can take 20-30 seconds. If other calls time out, check connectivity to `api.nitrosend.com`.
  </Accordion>
</AccordionGroup>
