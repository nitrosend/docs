...
Claude Desktop users should use the Custom Connector flow, not the Nitrosend
CLI. The CLI is for terminal and CI workflows after you specifically choose the
shell surface.
