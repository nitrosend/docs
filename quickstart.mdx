...
In **Brand > Domains**, activate the protected Nitrosend address reserved for
...
If you prefer to integrate programmatically, grab your API key from **Brand > API Keys** and check the [API Reference](/api/).
