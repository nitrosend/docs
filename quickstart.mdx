...
<Card title="Are you an AI agent?" icon="robot" href="/agent-onboarding">
  Read the Agent Onboarding page for the full tool surface, send modes, and the headless signup-to-send path, or fetch the machine-readable skill at nitrosend.com/skill.md.
</Card>
