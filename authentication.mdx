...
Generate an API key from **Settings > API Keys** in the dashboard ([app.nitrosend.com/my/settings/api-keys](https://app.nitrosend.com/my/settings/api-keys)). Keys are prefixed with `nskey_live_` for production and `nskey_test_` for test mode.
