...
This guide takes you from a verified domain to a working inbox your agent and your team answer together. For what the inbox is and how the queue works, see [Agent Inbox](/concepts/agent-inbox).
