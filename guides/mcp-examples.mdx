...
[Payments for agents](/guides/agent-payments) has complete MCP, CLI, and REST
flows. [Purchase lifecycle](/concepts/payment-lifecycle) explains approval,
idempotency, provider routing, and completion proof. Use the [MCP tools
reference](/mcp) for the current request and response fields.
